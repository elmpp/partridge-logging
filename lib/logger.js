...
const dumpable_error_1 = require("./dumpable-error");
...
class Logger {
    ...
    log(logLevelOrMessage, messageOrOptions, optionsArg) {
        ...
        if (typeof messageOrOptions === 'object' && messageOrOptions !== null) {
            ...
            throw new dumpable_error_1.DumpableError('Unrecognised log calls', { logLevelOrMessage, messageOrOptions, optionsArg });
        }
        this.logProvider.log(logLevel, message, Object.assign({}, options));
        return this;
    }
    dumpablesFormat(dumpables, logLevel) {
        const formatted = lodash_mapvalues_1.default(dumpables, (dumpables, dumpableKey) => {
