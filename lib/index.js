...
const type_util_1 = require("org-common/lib/type-util");
...
if (process.env.CLIENT_SERVER !== 'client' &&
    type_util_1.truthy(partridge_config_1.config.logging.LOGGING_STACKDRIVER_ENABLE)) {
...
if (type_util_1.truthy(partridge_config_1.config.logging.LOGGING_CONSOLE_ENABLE)) {
